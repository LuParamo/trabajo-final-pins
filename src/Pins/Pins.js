...
import PinRosa from './Pin-Avion-Rosa.PNG'
import PinAvianca from './Pin-Avianca.PNG'
import PinExplore from './Pin-Explore.PNG'
import PinCalaca from './Pin-Calaca.PNG'
import PinFrida from './Pin-Frida.PNG'
import PinHomero from './Pin-Mexico-Homero.PNG'
import PinVentanilla from './Pin-Ventanilla.PNG'
import PinValija from './Pin-Valija.PNG'
import PinWingo from './Pin-Wingo.PNG'
import PinViajeros from './Pins-viajeros.PNG'
